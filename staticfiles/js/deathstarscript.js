...
const icon = L.icon({
    iconUrl: 'staticfiles/images/isstracker/deathstar.png',
    iconSize: [70, 70],
    iconAnchor: [25, 94],
    popupAnchor: [20, -86]
});
...
L.tileLayer('https://api.mapbox.com/styles/v1/{id}/tiles/{z}/{x}/{y}?access_token={accessToken}', {
  ...
  tileSize: 512,
  zoomOffset: -1,
  accessToken: 'pk.eyJ1IjoiYmhlcmJlcnQ3IiwiYSI6ImNrZjVsYzd6czBvNDgyc250b3ppczRuc2QifQ.47KUFkibd15s8cNbu845QQ'
}).addTo(map);
